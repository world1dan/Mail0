          ...
          {loading ? (
            <div className="flex flex-col gap-2">
              {[...Array(2)].map((_, i) => (
                <Skeleton
                  key={i}
                  className="flex h-16 w-full flex-col items-center justify-center gap-2 rounded-2xl p-0"
                />
              ))}
            </div>
          ) : connections ? (
            connections.length > 0 ? (
              <div className="space-y-2">
                {connections?.map((connection) => (
                  <div
                    key={connection.id}
                    className="flex items-center justify-between rounded-2xl border p-2 transition-colors"
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex flex-col gap-1">
                        <span className="text-sm font-medium">none@nothing.com</span>
